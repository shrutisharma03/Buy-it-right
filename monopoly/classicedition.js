...
square[1] = new Square("Noida", "₹60", "#8B4513", 60, 3, 2, 10, 30, 90, 160, 250);
square[2] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[3] = new Square("Mumbai", "₹60", "#8B4513", 60, 3, 4, 20, 60, 180, 320, 450);
square[4] = new Square("House Tax", "Pay ₹200", "#FFFFFF");
square[5] = new Square("Raipur Railways", "₹200", "#FFFFFF", 200, 1);
square[6] = new Square("Orrisa", "₹100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[8] = new Square("Vellore", "₹100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("Surat", "₹120", "#87CEEB", 120, 4, 8, 40, 100, 300, 450, 600);
square[10] = new Square("Just Visiting", "", "#FFFFFF");
square[11] = new Square("Indore", "₹140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
square[12] = new Square("Electric Company", "₹150", "#FFFFFF", 150, 2);
square[13] = new Square("Shimla", "₹140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
square[14] = new Square("Patna", "₹160", "#FF0080", 160, 5, 12, 60, 180, 500, 700, 900);
square[15] = new Square("Chandigarh Railways", "₹200", "#FFFFFF", 200, 1);
square[16] = new Square("Goa", "₹180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[18] = new Square("Hyderabad", "₹180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[19] = new Square("Bangalore", "₹200", "#FFA500", 200, 6, 16, 80, 220, 600, 800, 1000);
square[20] = new Square("Free Parking", "", "#FFFFFF");
square[21] = new Square("Ghaziabad", "₹220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[23] = new Square("Jammu", "₹220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("Srinagar", "₹240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("Pune Railways", "₹200", "#FFFFFF", 200, 1);
square[26] = new Square("Ahemedabad", "₹260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Jaipur", "₹260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Water Works", "₹150", "#FFFFFF", 150, 2);
square[29] = new Square("Nagpur", "₹280", "#FFFF00", 280, 8, 24, 120, 360, 850, 1025, 1200);
square[30] = new Square("Go to Jail", "Go directly to Jail. Do not pass GO. Do not collect ₹200.", "#FFFFFF");
square[31] = new Square("Cochin", "₹300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[32] = new Square("Ranchi", "₹300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("Delhi", "₹320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Jodhpur Railways", "₹200", "#FFFFFF", 200, 1);
square[36] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[37] = new Square("Kota", "₹350", "#0000FF", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("LUXURY TAX", "Pay ₹100", "#FFFFFF");
square[39] = new Square("Lucknow", "₹400", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
